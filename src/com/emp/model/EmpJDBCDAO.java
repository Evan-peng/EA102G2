...
public class EmpJDBCDAO implements I_EmpDAO {
	...
	private static final String INSERT_STMT = 
			"INSERT INTO EMPLOYEE(EMP_ID,EMP_FIRSTNAME,EMP_LASTNAME,DEPT_NO,SALARY,HIREDATE,PASSWORD,STATUS)VALUES ('E' || LPAD(SEQ_MEM_ID.NEXTVAL, 4, '0'),?,?,?,?,TO_DATE(TO_CHAR(?,'YYYYMMDD'),'YYYY-MM-DD'), DBMS_RANDOM.STRING('x', 3) || DBMS_RANDOM.STRING('a', 3) || DBMS_RANDOM.STRING('x', 3),?)";
	private static final String GET_ALL_STMT = 
			"SELECT EMP_ID,EMP_FIRSTNAME,EMP_LASTNAME,DEPT_NO,SALARY,HIREDATE,PASSWORD,STATUS FROM EMPLOYEE";
	private static final String GET_ONE_STMT = 
			"SELECT EMP_ID,EMP_FIRSTNAME,EMP_LASTNAME,DEPT_NO,SALARY,HIREDATE,PASSWORD,STATUS FROM EMPLOYEE WHERE EMP_ID = ?";
	private static final String UPDATE =
			"UPDATE EMPLOYEE SET EMP_FIRSTNAME = ?,EMP_LASTNAME = ?,DEPT_NO = ?,SALARY = ?,HIREDATE = TO_DATE(TO_CHAR(?,'YYYYMMDD'),'YYYY-MM-DD'), PASSWORD = ?,STATUS = ? WHERE EMP_ID = ?";
	...
	public static void main (String[] args) {
		...
		empVO01.setEmp_lastname("萌萌");
		empVO01.setDept_no("D0001");
